  ...
  return (
    ...
    >
      ...
      <ul className="grid sm:grid-cols-2  md:grid-cols-3 lg:grid-cols-6 rows-2 w-full h-fit gap-5">
        <li className="bg-[#1b1c1e] sm:col-span-2 md:col-span-3 lg:col-span-3 lg:row-span-1 rounded-2xl shadow-highLight border-[1px] border-white border-opacity-[15%] h-[450px] justify-center flex flex-col p-10 gap-10">
          <h1 className="text-[#FFF5EE] font-semibold text-[75px]">
            Get in Touch
          </h1>
