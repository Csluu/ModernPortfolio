...
const LinkAnchor = ({
	...
	return isResumePage ? (
		<Link to="/">
			<div
				className="text-[#1b1c1e] font-semibold text-lg hover:text-orange-500 transition duration-150 hover:ease-in-out"
...
const LinkName = ({ setSelectedPage }) => {
	return (
		<AnchorLink
			className="flex w-full font-semibold text-lg text-[#1b1c1e]"
			style={{ textShadow: "1px 2px  rgb(0 0 0 /0.2)" }}
			href="#About"
					...
					>
						<h1 className="xs:w-fit sm:w-36">
							{isResumePage ? (
								<Link
									to="/"
									className="font-semibold text-lg text-[#1b1c1e]"
									style={{ textShadow: "1px 2px  rgb(0 0 0 /0.2)" }}
								>
									Christopher Luu
								</Link>
