  ...
  return (
    ...
    >
      ...
      <ul className="grid sm:grid-cols-2  md:grid-cols-3 lg:grid-cols-4  lg-grid-rows-3 w-full h-fit gap-5">
        <li className="bg-orange-500 sm:col-span-2 md:col-span-1 lg:col-span-4 rounded-xl shadow-highLight border-[1px] saturate-[100%] border-white border-opacity-[15%] h-80 flex justify-center p-5 gap-5">
        ...
        <li className="sm:col-span-2 md:col-span-1 rounded-xl shadow-highLight  border-[1px] border-white border-opacity-[15%] md:h-80 sm:h-auto bg-[#1b1c1e] hover:shadow-glow hover:shadow-orange-500 hover:scale-[101%] hover:ease-in-out transition duration-150 flex items-center justify-center">
          <a
        ...
        <li className="bg-[#1b1c1e] sm:col-span-2 md:col-span-1 lg:col-span-1 rounded-xl shadow-highLight  border-[1px] border-white border-opacity-[15%] h-80 flex justify-center p-10 gap-3 hover:shadow-glow hover:shadow-orange-500 hover:scale-[101%] hover:ease-in-out transition ">
          <img
        ...
        <li className=" sm:col-span-2 md:col-span-1 lg:col-span-2 lg:row-span-2 rounded-xl shadow-highLight  border-[1px] border-white border-opacity-[15%] md:h-160 sm:h-auto bg-[#1b1c1e]  p-10 flex flex-col justify-center">
          ...
          <p className="h-fit text-[25px] m-2 text-[#FFEBDD]">
        ...
        <li className=" sm:col-span-2 md:col-span-1 lg:col-span-1 rounded-xl shadow-highLight  border-[1px] border-white border-opacity-[15%] md:h-80 sm:h-auto bg-[#1b1c1e] hover:shadow-glow hover:shadow-orange-500 hover:scale-[101%] hover:ease-in-out transition duration-150 flex items-center justify-center">
          <a
